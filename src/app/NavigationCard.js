...
export default function NavigationCard() {
  ...
  return (
    <Card noPadding={true}>
      <div className="-mx-3  py-3 md:px-6 md:py-2 flex  justify-between md:block shadow-md shadow-gray-300 md:shadow-none">
        <h2 className="text-orange-500 shadow-md rounded-md text-center text-4xl shadow-gray-400  font-mono mb-3 hidden md:block">
          Text<span className="text-gray-500">One</span>
        </h2>
        <Link
          href="/"
          className={
